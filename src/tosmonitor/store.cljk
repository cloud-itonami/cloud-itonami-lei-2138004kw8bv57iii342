(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Publicis Groupe SA, LEI
  2138004KW8BV57III342) -- unlike `commitledger.store`'s multi-application
  ...
  légales\" legal notice, not a terms-of-service page)."
...
(defn demo-company []
  {:legal-name "Publicis Groupe SA"
   :website    "https://www.publicisgroupe.com"})

(def ^:private demo-full-text
  "Mentions légales\nCe site est publié par Publicis Groupe SA, société holding du groupe de communication et publicité français, dont le siège social est situé au 133, avenue des Champs-Elysées, 75008 Paris. L'utilisation du Site est soumise au respect des conditions générales d'accès et d'utilisation détaillées ci-dessous et des lois applicables en France. Les présentes conditions sont soumises à la loi française et, en cas de litige, les tribunaux français seront seuls compétents.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.publicisgroupe.com/fr/mentions-legales"
